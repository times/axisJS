...
describe('Service: axisOutput', function () {
  ...
  it('should export data back to Axis Server if the "Export to CMS" button is clicked', inject(function ($compile, $httpBackend){
    // Arrange
    element = angular.element('<a href="#" export-chart="axis" id="a-button">');
  ...
  it('should return an object with config, base64 PNG and title on preprocess()');
  it('should push a postMessage to parent iframe on process()');
  it('should run preprocess, process and complete on axisOutput.export()');
  it('should return an object with config and input data on axisOutput.import()');
});
